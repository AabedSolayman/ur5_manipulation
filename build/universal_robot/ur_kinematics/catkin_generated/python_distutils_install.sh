...
echo_and_run cd "/home/legoboost/catkin_ws_internship/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/legoboost/catkin_ws_internship/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/legoboost/catkin_ws_internship/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
